...
Phase~4 was also run at scale: with $N = 10{,}000$ real memories ($\theta = 0.85$), full composition takes 0.007\,s and retrieval takes $\sim$20\,s, returning 9{,}990 nodes. The retrieval time reflects the high density of intra-topic similar pairs typical of real embeddings; composition remains $O(N)$ and practical even at scale.
